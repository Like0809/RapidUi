 ...
 * Todd Davies' Progress Wheel https://github.com/Todd-Davies/WheelProgress
 *
...
public class WheelProgress extends View {
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius =
                (int) a.getDimension(R.styleable.WheelProgress_wp_circleRadius, circleRadius);

        fillRadius = a.getBoolean(R.styleable.WheelProgress_wp_fillRadius, false);

        barWidth = (int) a.getDimension(R.styleable.WheelProgress_wp_barWidth, barWidth);

        rimWidth = (int) a.getDimension(R.styleable.WheelProgress_wp_rimWidth, rimWidth);

        float baseSpinSpeed =
                a.getFloat(R.styleable.WheelProgress_wp_spinSpeed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime =
                a.getInt(R.styleable.WheelProgress_wp_barSpinCycleTime, (int) barSpinCycleTime);

        barColor = a.getColor(R.styleable.WheelProgress_wp_barColor, barColor);

        rimColor = a.getColor(R.styleable.WheelProgress_wp_rimColor, rimColor);

        linearProgress = a.getBoolean(R.styleable.WheelProgress_wp_linearProgress, false);

        if (a.getBoolean(R.styleable.WheelProgress_wp_progressIndeterminate, false)) {
            spin();
        }
